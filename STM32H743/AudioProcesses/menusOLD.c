...
uint8_t	i=0;
	while(screen[i].line[0] != 0x20 )
	{
		...
		{
			ST7735_WriteString(screen[i].x,   screen[i].y,MenuStruct.Header,  USED_FONT, ST7735_BLUE, ST7735_BLACK);
			ST7735_WriteString(screen[i].x+(strlen(MenuStruct.Header)*7)+6,screen[i].y,MenuStruct.Version, USED_FONT, ST7735_BLUE, ST7735_BLACK);
		}
		if ( i == 1 )
		{
			MenuStruct.menu_line_counter = 1;
			ST7735_WriteString(screen[i].x,screen[i].y,screen[i].line, USED_FONT, ST7735_BLACK, ST7735_BLUE);
		}
		else
			ST7735_WriteString(screen[i].x,screen[i].y,screen[i].line, USED_FONT, ST7735_BLUE, ST7735_BLACK);
		i++;
	}
}
